...
src_chain_name_caps="POLYGONAMOY"
dest_chain_name="ethereumHolesky"
dest_chain_name_caps="ETHEREUMHOLESKY"

# Load configs
source_env $USER_CONFIG_ENV_FILE
source_env $USER_CHAINS_ENV_FILE

src_chain_id=$(_get_chain_env $src_chain_name_caps "CHAIN_ID")
src_chain_eid=$(_get_chain_env $src_chain_name_caps "ENDPOINT_ID")
dest_chain_id=$(_get_chain_env $dest_chain_name_caps "CHAIN_ID")
dest_chain_eid=$(_get_chain_env $dest_chain_name_caps "ENDPOINT_ID")
...
# setup chains
start_chain $src_chain_name $(( BASE_PORT + 1 ))
start_chain $dest_chain_name $(( BASE_PORT + 2 ))
start_ssl_proxy $(( BASE_PORT + 1 )) $(( BASE_PORT + 3 ))
start_ssl_proxy $(( BASE_PORT + 2 )) $(( BASE_PORT + 4 ))
...
# fund admin
fund_account $src_chain_name $(( BASE_PORT + 1 )) $admin_address
fund_account $dest_chain_name $(( BASE_PORT + 2 )) $admin_address
...
src_chain_dvn_address=$(_get_chain_env $src_chain_name_caps "DVN_ADDRESS")
src_chain_oapp_address=$(_get_chain_env $src_chain_name_caps "OAPP_ADDRESS")
dest_chain_dvn_address=$(_get_chain_env $dest_chain_name_caps "DVN_ADDRESS")
dest_chain_oapp_address=$(_get_chain_env $dest_chain_name_caps "OAPP_ADDRESS")
...
fund_account $src_chain_name $(( BASE_PORT + 1 )) $dvn_address
fund_account $dest_chain_name $(( BASE_PORT + 2 )) $dvn_address
