...
yarn suite:new
yarn suite:add ethereumHolesky
yarn suite:add polygonAmoy
yarn suite:start &

until grep "Suite ready" "$SINK_LOGS_DIR/bash.txt" >/dev/null 2>&1; do
    sleep .1
done
...
echo "Starting test" | pretty_log bash

export SOURCE_CHAIN_NAME="ethereumHolesky"
export DESTINATION_CHAIN_NAME="polygonAmoy"
npx mocha